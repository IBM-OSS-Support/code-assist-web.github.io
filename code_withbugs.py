...
class Library:
    ...
    def search_book(self, search_term):
        found = [book for book in self.books.values() if search_term in book.title] 
        if found == None:  
